...
public class CarManager : MonoBehaviour
{
    ...
    private void Update()
    {
        /*LogOnScreen.Instance.HandleLog(WasTapped().ToString(), "", LogType.Log);
        LogOnScreen.Instance.OnGUI();*/
        if (Car == null && Reticle.CurrentPlane != null)
        {
    ...
    /*private bool WasTapped()
    {
        ...
        var touch = InputSystem.EnhancedTouch.Touch.activeTouches[i];
